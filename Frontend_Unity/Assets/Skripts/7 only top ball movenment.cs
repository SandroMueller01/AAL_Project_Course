...
public class onlytopballmovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Nur bewegen, wenn der oberste Ball in der ausgewählten Säule ist
    ...
    {
        // Setze alle Seitenwände auf die Standardfarbe
        ResetWallColors();

        // Wähle die Seitenwände der ausgewählten Säule aus und setze die Farbe
    ...
    // Setze die Farben aller Seitenwände auf die Standardfarbe
